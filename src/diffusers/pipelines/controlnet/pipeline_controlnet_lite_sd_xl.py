...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from diffusers import StableDiffusionXLControlNetLitePipeline, ControlNetModel, AutoencoderKL
        ...
        >>> pipe = StableDiffusionXLControlNetLitePipeline.from_pretrained(
...
class StableDiffusionXLControlNetLitePipeline(
    ...
    def __init__(
        ...
        unet: UNet2DConditionModel,
        controlnet: Union[ControlNetLLLite, ControlNetModel, List[ControlNetModel], Tuple[ControlNetModel], MultiControlNetModel],
    ...
    def __call__(
        ...
        for i in range(len(timesteps)):
            ...
            controlnet_keep.append(keeps[0] if isinstance(controlnet, ControlNetLLLite) else keeps)
