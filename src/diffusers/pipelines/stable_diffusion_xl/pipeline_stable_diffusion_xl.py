    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                logger.warning(f'prompt_embeds: {prompt_embeds}')
                logger.warning(f'prompt_embeds.shape: {prompt_embeds.shape}')
                logger.warning(f'prompt_embeds.dtype: {prompt_embeds.dtype}')
                logger.warning(f'prompt_embeds.device: {prompt_embeds.device}')
